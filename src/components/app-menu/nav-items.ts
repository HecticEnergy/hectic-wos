...
export const topItems: NavItemProps[] = [
  ...
  },
  {
    ...
    onClick: undefined,
    to: undefined,
    dataTour: "march-times-nav-bar-link",
    prependDivider: false,
    appendDivider: false,
    subItems: [
      {
        ...
        dataTour: "march-time-nav-bar-link",
        prependDivider: false,
        appendDivider: false,
        subItems: undefined,
      },
      {
        ...
        dataTour: "create-member-single-nav-bar-link",
        prependDivider: false,
        appendDivider: false,
        subItems: undefined,
      },
...
export const bottomItems: NavItemProps[] = [
  {
    ...
    dataTour: "ministry-appointments-nav-bar-link",
    prependDivider: false,
    appendDivider: false,
    subItems: undefined,
  },
...
export const testItems: NavItemProps[] = [
  {
    ...
    onClick: undefined,
    to: undefined,
    dataTour: "test-page-nav-bar-link",
    prependDivider: false,
    appendDivider: false,
    subItems: [
      {
      ...
      },
      {
        ...
        dataTour: "colors-page-nav-bar-link",
        prependDivider: false,
        appendDivider: false,
        subItems: undefined,
      },
      {
        ...
        dataTour: "transitions-page-nav-bar-link",
        prependDivider: false,
        appendDivider: false,
        subItems: undefined,
      },
